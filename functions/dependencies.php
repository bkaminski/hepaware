...
function enqueue_integral_scripts() {
    ...
    wp_enqueue_script('integral-scripts', get_template_directory_uri() . '/assets/js/haScripts.min.js', array('jquery'), null, true, null);
}
...
function enqueue_integral_styles() {
    ...
    wp_enqueue_style('integral-styles', get_template_directory_uri() . '/assets/styles/haStyles.min.css');
}
