...
{
    global $post;
    return $output . '<a class="btn btn-lg btn-outline-red2 rounded-0" href="' . get_permalink() . '">Read More <i class="fas fa-angle-double-right fa-fw fa-lg"></i></a>';
}
...
//begin pagination
function ha_pagination($pages = '', $range = 1)
{
    $showitems = ($range * 2) + 1;
