<div class="home-mission">
	<div class="container">
		<h2 class="h5 text-center tertiary-heading text-uppercase pt-5 pb-5">Mission and Objectives</h2>
			<div class="container">
				<h1 class="display-4 text-center text-white"><?php echo get_bloginfo(); ?></h1>
				...
				<div class="text-center pt-5 pb-5">
					<a class="btn btn-outline-red1 btn-lg rounded-0 pr-5 pl-5" href="#" role="button">Donate Now <i class="fas fa-angle-double-right fa-fw fa-lg"></i></a>
				</div>
			</div>
	</div>
</div>
